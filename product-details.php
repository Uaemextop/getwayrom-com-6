...
<style type="text/css">
/* Premium Product Details Styling */
:root {
    --primary-dark: #182a3e;
    --primary-green: #859f1b;
    --accent-green: #69a909;
    --light-green: #a0b93a;
    --bright-green: #1D970D;
    --primary-blue: #1574d6;
...
.zoompro-border22.zoompro-span22 {
    text-align: center;
    margin-bottom: 20px;
    border-radius: 12px;
    overflow: hidden;
...
.zoompro-border22.zoompro-span22:first-child {
    display: block;
}

.zoompro-border22.zoompro-span22:hover {
    transform: scale(1.02);
}

.zoompro-22 .zoompro-span22 img {
    width: auto;
    max-width: 100%;
    object-fit: contain;
    border-radius: 12px;
...
.product-dec-slider-2 > div:hover {
    border-color: var(--primary-green);
    transform: scale(1.05);
}

.product-dec-slider-2 > div.active {
    border-color: var(--primary-green);
    box-shadow: 0 0 10px rgba(133, 159, 27, 0.3);
}

.product-dec-slider-2 img {
    width: 100%;
    height: 100%;
    object-fit: cover;
}
...
.product-details-content-premium {
    background: #fff;
    border-radius: 15px;
    padding: 30px;
    box-shadow: 0 5px 20px rgba(0,0,0,0.08);
...
.product-details-content-premium h2 {
    font-size: 32px;
    font-weight: 700;
...
.pro-details-cart button {
    ...
    cursor: pointer;
    transition: all 0.3s ease;
    box-shadow: 0 5px 15px rgba(133, 159, 27, 0.3);
}

.pro-details-cart button:hover {
    transform: translateY(-2px);
    box-shadow: 0 8px 20px rgba(133, 159, 27, 0.4);
}
...
.pro_details_buy_link_area a {
    display: inline-block;
    margin-right: 10px;
    margin-bottom: 10px;
}

.pro_details_buy_link_area img {
    height: 45px;
    border-radius: 8px;
    transition: transform 0.3s ease;
}

.pro_details_buy_link_area img:hover {
    transform: scale(1.05);
}
...
.premium-tab-link.active {
    ...
    background: linear-gradient(to top, rgba(133, 159, 27, 0.05) 0%, transparent 100%);
}
...
.premium-tab-panel ul,
.premium-tab-panel ol {
    padding-left: 20px;
    margin-bottom: 20px;
}

.premium-tab-panel ul li,
.premium-tab-panel ol li {
    font-size: 15px;
    line-height: 1.8;
    color: var(--text-light);
    margin-bottom: 10px;
...
.product_blkiteminner:hover .product_blkitem_thumb img {
    transform: scale(1.1);
}
...
.product_blkitem_name h4 a:hover {
    color: var(--primary-green);
}
    ...
    <div class="search_container">
      ...
      setTimeout(() => {
          try {
            ...
            <section class="breadcrumb-area" style="padding: 20px 0;text-align: left;background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);border-bottom: 1px solid #e1e8ed;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="breadcrumb-content" style="padding: 0 5px;">
                                <ul class="breadcrumb-links" style="display: flex; gap: 10px; align-items: center; list-style: none; margin: 0; padding: 0;">
                                    <li style="display: flex; align-items: center;">
                                        <a href="index.php" style="color: #859f1b; font-weight: 500; transition: color 0.3s;">
                                            <i class="ion-ios-home" style="margin-right: 5px;"></i> Home
                                        </a>
                                        <span style="margin: 0 10px; color: #ccc;">/</span>
                                    </li>
                                                                        <li style="color: #6c757d; font-weight: 600;">
                                        OPPO                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <section class="product-details-area product-details-premium mtb-60px" style="margin-top:20px;">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="product-details-img product-details-tab product-image-section">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            ...
                            <div class="product-details-content product-details-content-premium">
                                <h2>OPPO</h2>
								...
								<div style="padding-bottom:15px;"><b><h4 style="font-size:14px; font-weight:bold;">ALSO AVAILABLE AT</h4></b></div>
								    ...
								    <a href="https://api.whatsapp.com/send?phone=919420630774&text=*I%20want%20to%20Buy*%20OPPO%20https://www.getwayrom.com/product-details.php?id=3" class="whatsapp_link" target="_blank">
                                    ...
                                    <div class="social-info">
                                        <ul>
                                            <li><a href="https://www.facebook.com/sharer.php?u=http://getwayrom.com/product-details.php?id=3" target="_blank"><i class="ion-social-facebook"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://twitter.com/intent/tweet?text=OPPO&url=http://getwayrom.com/product-details.php?id=3" target="_blank"><i class="ion-social-twitter"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://plus.google.com/share?url=http://getwayrom.com/product-details.php?id=3" target="_blank"><i class="ion-social-google"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://www.instagram.com/?url=http://getwayrom.com/product-details.php?id=3" target="_blank"><i class="ion-social-instagram"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://api.whatsapp.com/send?phone=919420630774&text=Interested%20to%20Buy%20https://www.getwayrom.com/product-details.php?id=3" target="_blank"><i class="ion-social-whatsapp"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <!-- Premium Tabs Section Start -->
            <div class="premium-tabs-section">
                <div class="container">
                    <div class="premium-tabs-navigation">
                        <button class="premium-tab-link active" onclick="openTab(event, 'tab-description')">
                            <i class="ion-ios-list-outline"></i> Product Description
                        </button>
                        <button class="premium-tab-link" onclick="openTab(event, 'tab-return-policy')">
                            <i class="ion-ios-loop"></i> Return Policy
                        </button>
                    </div>
                    
                    <div id="tab-description" class="premium-tab-content active">
                    ...
                    <div id="tab-return-policy" class="premium-tab-content">
                        <div class="premium-tab-panel">
                            ...
                            <div style="text-align:justify;">
                                <p><strong>Standard Return Policy:</strong></p>
                                    <ul>
                                        ...
                                        <li>Product must be in original condition with all tags intact</li>
                                        <li>Refund will be processed within 7-10 business days</li>
                                        <li>Shipping charges are non-refundable</li>
                                        <li>Digital products and services are non-returnable</li>
                                    </ul>
                                    <p>For any queries regarding returns, please contact our customer support.</p>                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Premium Tabs Section End -->
...
// Premium Tabs Functionality
function openTab(evt, tabName) {
    var i, tabcontent, tablinks;
    
    // Hide all tab contents
    tabcontent = document.getElementsByClassName("premium-tab-content");
...
// Smooth scroll for product images
$(document).ready(function() {
    // Set first thumbnail as active
    $('.product-dec-slider-2 > div:first').addClass('active');
    
    $('.product-dec-slider-2 > div').click(function() {
        var index = $(this).index();
        
        // Update active thumbnail
        $('.product-dec-slider-2 > div').removeClass('active');
        $(this).addClass('active');
        
        // Show corresponding image
        $('.zoompro-border22').hide();
        $('.zoompro-border22').eq(index).fadeIn(300);
    });
});
</script>
